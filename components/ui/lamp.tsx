...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] flex-col items-center justify-center overflow-hidden bg-black-100 rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-screen flex-1 scale-y-125 h-[500px] items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-black-200 opacity-50 blur-3xl"></div> */}
        <motion.div
          initial={{ width: "8rem" }}
